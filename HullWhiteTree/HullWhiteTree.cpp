...
// print gamma
void HullWhiteTree::print_gamma()
{
...
void HullWhiteTree::print_tree()
{
    cout<<"After constructing the Hull White Tree and calculating Gamma, we can calibrate interest rate tree:"<<endl;
    cout<<endl;
    for(int i=0;i<=jmax;i++)
    {
        cout<<"------------------------------------"<<endl;
...
vector<double> HullWhiteTree::normal_prob(int step, int j_)
{
    int j = step - j_;
    vector<double> prob;
    prob.resize(3);
...
vector<double> HullWhiteTree::top_prob(int j_)
{
    int j = jmax - j_;
    vector<double> prob;
    prob.resize(3);
...
vector<double> HullWhiteTree::bot_prob(int j_)
{
    int j= jmax - j_;
    vector<double> prob;
    prob.resize(3);
